          ...
          <section className="grid gap-4 sm:grid-cols-3">
            <Card className="border-sky-100/80 bg-gradient-to-br from-white to-sky-50/70 shadow-sm">
              <CardHeader className="flex flex-row items-center gap-3 space-y-0">
                ...
                <div>
                  <CardTitle className="text-base text-slate-900">안녕하세요, SOL</CardTitle>
              ...
              <CardContent className="flex items-center justify-between pt-0 text-sm">
                ...
                <Badge className="bg-blue-600 text-white">Priority</Badge>
              </CardContent>
            </Card>
            ...
            <Card className="border-sky-100/80 bg-white/80 shadow-sm backdrop-blur">
              ...
              <CardContent className="space-y-2 pt-0 text-sm">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-sky-700">320 P</span>
                </div>
                <div className="flex items-center justify-between text-slate-600">
                  <span>회복 예정</span>
                  <span>6월 1일 +80 P</span>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-700">
                  WON · PENDING 상태를 확인하고 필요한 알림을 설정하세요.
                </p>
              </div>
          ...
          <section className="grid gap-4 sm:grid-cols-3">
            ...
            <Card className="border-sky-100/80 bg-white/80 shadow-sm backdrop-blur">
              ...
              <CardContent className="space-y-2 pt-0 text-sm text-slate-700">
                <p>최근 90일 PENDING 4건</p>
                <p className="text-slate-600">승인 2 · 대기 1 · 취소 1</p>
              </CardContent>
            </Card>
